 ...
 *
 */
public class CoreServlet_waiBao extends HttpServlet {  
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {  	
            ...
            String result = null;  
            try {
                WXBizMsgCrypt wxcpt = new WXBizMsgCrypt(WeiXinParamesUtil_waiBao.token, WeiXinParamesUtil_waiBao.encodingAESKey, WeiXinParamesUtil_waiBao.corpId);  
                result = wxcpt.VerifyURL(msg_signature, timestamp, nonce, echostr);  
            } catch (AesException e) {  
                e.printStackTrace();  
            }  
            if (result == null) {  
                result = WeiXinParamesUtil_waiBao.token;  
            }  
            out.print(result);  
            out.close();  
            out = null;  
