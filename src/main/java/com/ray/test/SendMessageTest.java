...
import com.ray.pojo.message.qyWeiXinSend.Article;
import com.ray.pojo.message.qyWeiXinSend.FileMessage;
import com.ray.pojo.message.qyWeiXinSend.ImgMessage;
import com.ray.pojo.message.qyWeiXinSend.Media;
import com.ray.pojo.message.qyWeiXinSend.News;
import com.ray.pojo.message.qyWeiXinSend.NewsMessage;
import com.ray.pojo.message.qyWeiXinSend.Text;
import com.ray.pojo.message.qyWeiXinSend.TextMessage;
import com.ray.pojo.message.qyWeiXinSend.Textcard;
import com.ray.pojo.message.qyWeiXinSend.TextcardMessage;
import com.ray.pojo.message.qyWeiXinSend.Video;
import com.ray.pojo.message.qyWeiXinSend.VideoMessage;
import com.ray.pojo.message.qyWeiXinSend.VoiceMessage;
...
public class SendMessageTest {
	...
	public void testSendTextMessage(){
		...
		//1.1非必需
		message.setTouser("HaoZongCheng");  //不区分大小写
