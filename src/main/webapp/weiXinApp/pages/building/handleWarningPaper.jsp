					...
					<article class="weui_article" style="border: 1px solid #4F77AA;">
						<div class="weui_cells">
							<div class="weui_cell">
								...
								<div class="weui_cell_ft">门锁类</div>
							</div>
				            ...
				            <div>
				                ...
				                <div class="task_content_style">
				                	<div class="demo-list" style="margin: 20px auto;">
			                			<a href="<%=path %>/weiXinApp/images/icon1.png" class="js-smartPhoto" id="warning_photo" data-caption="Photo">
											<img src="<%=path %>/weiXinApp/images/icon1.png" border="1"/>
										</a>
			                			<a href="<%=path %>/weiXinApp/images/icon1.png" class="js-smartPhoto" id="warning_photo" data-caption="Photo">
											<img src="<%=path %>/weiXinApp/images/icon1.png" border="1"/>
										</a>
				            ...
				            <div class="weui_cell">
								...
								<div class="weui_cell_ft">李文建</div>
							</div>
							<div class="weui_cell">
								<div class="weui_cell_bd weui_cell_primary">
									<p>报修时间:</p>
								</div>
								<div class="weui_cell_ft">2017-12-28 11:12</div>
							</div>
							<a href="javascript:;" class="weui_btn weui_btn_primary" style="text-decoration:none">接收任务</a>
							<a href="javascript:;" class="weui_btn weui_btn_primary" style="text-decoration:none">维修报告</a>
						</div>
					</article>
	            </div>  
	        </div> 
