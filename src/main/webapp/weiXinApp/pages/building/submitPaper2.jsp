	            ...
	            <div class="entry">
					...
					<article class="weui_article" style="border: 1px solid #4F77AA;">
						<div class="weui_cells">
							...
							<a href="javascript:;" class="weui_btn weui_btn_primary" style="text-decoration:none">通知单作废</a>
							<a href="javascript:;" class="weui_btn weui_btn_primary" style="text-decoration:none">通知单下发</a>
						</div>
					</article>
	            </div>  
	        </div> 
