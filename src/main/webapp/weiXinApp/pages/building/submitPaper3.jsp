...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
	<div id="main_container">
	    ...
	    <span>故障详情</span>
	    <a href="<%=path %>/weiXinApp/pages/building/connToSender.jsp" class="right_bt" id="activator"><img src="<%=path %>/weiXinApp/images/xinxi.png" alt="" title="" border="0" /></a>
	    </div>  
		<div class="content">
					...
					<article class="weui_article" style="border: 1px solid #4F77AA;">
						<div class="weui_cells">
				            ...
				            <div class="weui_cell">
								...
								<div class="weui_cell_ft">曲松松</div>
							</div>
							<div class="weui_cell">
								<div class="weui_cell_bd weui_cell_primary">
									<p>报修时间:</p>
								</div>
								<div class="weui_cell_ft">2018-01-27 11:12</div>
							</div>
							<a href="javascript:;" class="weui_btn weui_btn_primary" style="text-decoration:none">处理故障</a>
						</div>
					</article>
	            </div>  
	        </div> 
